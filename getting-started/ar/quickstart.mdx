...
2. Click "New App" button to create a new App.
   ...
   <img
     src="/images/quickstart/create-app-ar.png"
...
3. Set up Your App by adding **App Logo** and **App Name**, and Add At least 1 **callback URL**.
   ...
   ![Create App2 En Pn](/images/quickstart/create-app2-ar.png)

   ![Create App3 En Pn](/images/quickstart/create-app3-ar.png)
4. Regenerate your AppSecret, then copy appId and appSecret For Later Use.

   ![Create App4 En Pn](/images/quickstart/create-app4-ar.png)
