...
2. Click "New App" button to create a new App.
   ...
   <img
     ...
     style={{ width:"100%" }}
   />
3. Set up Your App by adding **App Logo** and **App Name**, and Add At least 1 **<Tooltip tip="The callback URL is the page link to redirect the user to after login">callback URL</Tooltip>**.
